...
class Localizer:
    ...
    def transform_coordinates(self, msg):
        # Transform msg.latitude and msg.longitude to UTM coordinates using
...
# cmds
# roslaunch autoware_mini_tutorial lesson2.launch interval:=1 waypoints_file:=waypoints_1m.csv
