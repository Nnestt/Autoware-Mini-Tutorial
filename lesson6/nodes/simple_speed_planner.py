...
class SimpleSpeedPlanner:
    ...
    def collision_points_and_path_callback(self, collision_points_msg, local_path_msg):
        try:
            ...
            # This is the distance base_link may travel before the car's front
...
#Calculate collision point speed.
            ...
            for waypoint in local_path_msg.waypoints:
                waypoint.speed = min(target_velocity, waypoint.speed)

            target_object_distance = (
                collision_point_distances[target_index]
                - self.distance_to_car_front
            )
            target_object_speed = collision_point_speeds[target_index]
            collision_point_braking_distance = collision_point_braking_distances[target_index]
